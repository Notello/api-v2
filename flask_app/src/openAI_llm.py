...
def get_graph_from_OpenAI(chunk_with_id, summary, courseId, userId, noteId):
    try:        
        return CustomKGBuilder.create_knowledge_graph(text=chunk_with_id.get('pg_content'), summary=summary)
