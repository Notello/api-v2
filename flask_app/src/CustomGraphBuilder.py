...
def create_unstructured_prompt(
    ...
    base_string_parts = [
        ...
        "- You must always provide relationships between the entities, never provide only entities with no relations."
        ,
    ]
...
relations from the provided text. You must **always** provide relationships between entities, never provide only entities with no relations.\n\n

# IMPORTANT NOTE:
If there were errors last time, they will be listed below:
Error: You did not provide any relationships between entities. Please provide relationships between entities.
