...
from flask_app.constants import COMMUNITY_DETECTION, COURSEID, LOUVAIN, NOTEID
...
class NodeUpdateService:
    ...
    def merge_similar_nodes(tx, id_type: str, target_id: str, note_id: str, distance: int = 2, embedding_cutoff: float = 0.97) -> None:
        ...
        logging.info(f"course com_string: {course_com_string}")
        logging.info(f"note com_string: {note_com_string}")
